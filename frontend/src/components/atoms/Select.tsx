...
export const Select: React.FC<React.SelectHTMLAttributes<HTMLSelectElement> & { options: {value: string, label: string}[] }> = ({ options, ...props }) => (
  <div className="relative">
    ...
    <ChevronDown className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none text-primary" size={20} strokeWidth={1.5} />
  </div>
);
